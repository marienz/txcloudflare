...
'''
    ...
    Set the security level for a zone. See:
...
class SetSecurityLevelRequest(HttpRequest):
    ...
    def pre_process(self, params):
        allowed_levels = ('help', 'high', 'med', 'low', 'eoff')
...
api_request = SetSecurityLevelRequest
