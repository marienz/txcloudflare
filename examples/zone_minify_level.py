...
'''
    ...
    Trivial example of how to set the minify level for a zone. See:
...
if __name__ == '__main__':
    ...
    cloudflare.minify(zone=domain_name, css=False, js=False, html=True).addCallback(got_response).addErrback(got_error)
    reactor.run()
